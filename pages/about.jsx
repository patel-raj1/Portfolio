    ...
    <>
      ...
      <div className={styles.container}>
        <div className={styles.card}>
          ...
          <span className={styles.span}>B. Tech. CSE (2021 - 2024)</span>
        ...
        <div className={styles.card}>
          ...
          <p className={styles.desc}>I have done Advance Excel course from Amity University<br /><br /></p>
        </div>
      </div>
      <div className={styles.container}>
        <div className={styles.card}>
          <h3 className={styles.title}>Gujarat Technological University</h3>
          <span className={styles.span}>Diploma CE (2018 - 2021)</span>
